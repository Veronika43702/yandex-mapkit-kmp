...
@Deprecated(
    ...
    replaceWith = ReplaceWith(expression = "ru.nikfirs.mapkit.map.SizeChangedListener")
)
public typealias SizeChangeListener = SizeChangedListener

@Deprecated(
    "SizeChangeListener renamed to SizeChangedListener as in original API.",
    replaceWith = ReplaceWith(expression = "ru.nikfirs.mapkit.map.SizeChangedListener(onMapWindowSizeChanged = onMapWindowSizeChanged)")
)
